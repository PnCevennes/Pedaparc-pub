...
def create_commentaire(data):
    ...
    Crée un objet Commentaire à partir des données passées en paramètre.
        ...
        Return(s):
                | commentaire (Commentaire): Objet Commentaire dont les attributs ont été remplis
    '''
...
def get_commentaire(id_commentaire):
    ...
    Retourne l'objet Commentaire dont l'Id a été passé en paramètre.
        ...
        Return(s):
                | commentaire (Commentaire): Objet Commentaire dont l'Id a été passé en paramètre
    '''
...
def get_commentaires(id_anim):
    '''
    Retourne tous les objets Commentaire liés à une animation dont l'Id est 
    passé en paramètre.

        Param(s):
                | id_anim (str): Id de l'objet Animation dont les commentaires sont voulus

        Return(s):
                | commentaires (Commentaire[]): Liste de tous les objets Commentaire liés à l'Animation dont l'Id est passé en paramètre
    '''
